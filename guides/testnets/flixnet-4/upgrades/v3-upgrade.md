...
**When**: The upgrade is scheduled for block [10974000](https://testnet.ping.pub/omniflix/block/10974000). (approximately 14:00 UTC, Feb 13th 2024)
...
### 1. Manual Method
Wait for flixnet-4 to reach the upgrade height (`10974000`)
...
output should be
```
commit: 014cdcf2e05953e144139052dbbc63af2b60ec94
...
# check the version - should be v3.0.0-alpha.1
...
# check new version you are about to run - should be equal to v3.0.0-alpha.1
